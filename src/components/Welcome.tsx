...
const Welcome: React.FC<ComponentProps> = ({ completed }) => {
  ...
  const typingEffect = () => {
    const myParagraph =
      "Portfolio CLI ----------------------------- <br /> Welcome to my CLI Portfolio [Version 1.0.0] <br /> Copyright © Aeliyadevs 2024. All rights reserved. <br /> ---- For a list of available commands, type 'help'.";
